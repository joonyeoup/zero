...
(function () {
    ...
    function analyze() {
        ...
        // The sidecar goes screenshot -> VLM; flip the label at roughly the
        // configured screenshot budget so the loading state stays honest.
        var labelTimer = setTimeout(function () {
            els.loadingText.textContent = "Asking the vision model…";
        }, 2500);
